...
bus_return_choice = int(input("\nChoose your return bus. Please enter 10:00 [1],12:00 [3],14:00 [5] or 16:00 [7]: "))
print("Return bus time chosen:",bus_time[bus_return_choice])

if bus_return_choice not in [1, 3, 5, 7]:
    print("Not a valid bus back.")


bus_capacity[bus_return_choice]= bus_capacity[bus_return_choice] - 1
bus_money[bus_return_choice] += charge
